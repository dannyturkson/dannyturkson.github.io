...
This paper estimates the causal effects of multidimensional school and household poverty on student achievement in Mathematics and English. Using data from the 2016/17 Young Lives school survey covering seventh- and eighth-grade students across 30 public schools in Ethiopia, we construct poverty indices at both the school and household levels, capturing deprivations in infrastructure, basic services, assets, health, and educational continuity. To address the endogeneity of lagged achievement and unobserved heterogeneity in learning ability, we estimate value-added models combining instrumental variables with latent class analysis (IV+LCA), exploiting cross-subject performance as an instrument and recovering five discrete student ability types from the joint distribution of test scores. Achievement is highly persistent across grades, but much of this persistence reflects stable differences in latent ability rather than true state dependence. Both poverty dimensions are strongly associated with lower scores in simpler specifications, yet the preferred IV+LCA estimates tell a more nuanced story: household poverty exerts a robust negative effect on both subjects, while school poverty loses statistical significance once student composition is properly accounted for. The findings make a case for redirecting at least part of education policy attention toward household deprivations, and demonstrate that measuring poverty in multiple dimensions reveals levers for interventions that income-based measures would miss.
