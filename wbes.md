...
The surveys capture private sector perspectives on key obstacles to doing business, with a focus on understanding the micro-economic foundations of growth. Data are collected using consistent methodology to enable cross-country and over-time comparisons.


### Topics Covered

<div class="topic-grid">
  <div class="topic-item">Access to Finance</div>
  <div class="topic-item">Infrastructure</div>
  <div class="topic-item">Corruption</div>
  <div class="topic-item">Regulation</div>
  <div class="topic-item">Business Performance</div>
  <div class="topic-item">Labor &amp; Skills</div>
  <div class="topic-item">Trade</div>
  <div class="topic-item">Innovation</div>
  <div class="topic-item">Energy</div>
  <div class="topic-item">Crime &amp; Security</div>
  <div class="topic-item">Gender</div>
